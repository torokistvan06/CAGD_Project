...
namespace cagd {
    ...
    HermiteCompositeCurve3::~HermiteCompositeCurve3() {
    ...
    GLboolean HermiteCompositeCurve3::InsertNewArc(CubicHermiteArc3* arc, GenericCurve3* image, GLfloat r, GLfloat g, GLfloat b, GLint index){
        ArcAttributes* element = new ArcAttributes;
    ...
    CubicHermiteArc3* HermiteCompositeCurve3::ContinueExisitingArc(GLuint index, int direction){
        ...
        DCoordinate3 left = _attributes[ind]->arc->GetCorner(0);
        DCoordinate3 right = _attributes[ind]->arc->GetCorner(1);
        DCoordinate3 leftTangent = _attributes[ind]->arc->GetTangent(0);
        DCoordinate3 rightTangent = _attributes[ind]->arc->GetTangent(1);
