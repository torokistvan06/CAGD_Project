...
public:
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Computer Aided Geometric Design | Curve and surface modeling | Simple Qt-Framework | Spring, 2022", nullptr));
